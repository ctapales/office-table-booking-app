INSERT INTO `tbl_user` (`id`, `create_at`, `modified_at`, `email`, `first_name`, `last_name`, `password`, `role`) VALUES
...
INSERT INTO `tbl_office` (`id`, `create_at`, `modified_at`, `number`) VALUES
...
INSERT INTO `tbl_desk` (`id`, `create_at`, `modified_at`, `number`, `officeid`) VALUES
